...
window.EARTH={
  ...
  waterfallList:[], placeList:[], goodList:[], shoalList:[], seaList:[],
  ...
  /* the nations of the wandering sea-beasts, each with its waters — see world/sea.js */
  sea:function(s){this.seaList.push(s);},
