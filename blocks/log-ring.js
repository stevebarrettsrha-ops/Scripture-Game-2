/* TIMBER — the ring-bark bole (§2.4.3 kept on the felled tree)
   ...
   §2.4.3 — barkRing — so the felled bole and the standing one are one look. */
EARTH.block({
  id:'log-ring', name:'Timber',
  tex:{all:'barkRing'},
  hardness:2.0,
  tool:'axe', drops:'log',
