/* TIMBER — the plate-bark bole (§2.4.3 kept on the felled tree)
   ...
   §2.4.3 — barkPlate — so the felled bole and the standing one are one look. */
EARTH.block({
  id:'log-plate', name:'Timber',
  tex:{all:'barkPlate'},
  hardness:2.0,
  tool:'axe', drops:'log',
